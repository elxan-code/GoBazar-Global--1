    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductToProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductToProducts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Image = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ProductToProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductImages_ProductToProducts_ProductToProductId",
                        column: x => x.ProductToProductId,
                        principalTable: "ProductToProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_ProductToProductId",
                table: "ProductImages",
                column: "ProductToProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductToProducts_ProductId",
                table: "ProductToProducts",
                column: "ProductId");
