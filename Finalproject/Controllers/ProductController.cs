...
namespace Finalproject.Controllers
{
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Message(VmComment model)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction(nameof(model.Product.Id));
            }
        ...
        public IActionResult ProductDetails(int? id)
        {
            ...
            //{
            //    Product=_context.Products.Include(cp => cp.ProductToProduct).ThenInclude(pi => pi.ProductImages).FirstOrDefault(p => p.Id == id),
